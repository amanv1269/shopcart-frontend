...
import { WomensKurti } from "../../data/WomensKurti";
...
const commonFilterClasses =
  "h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500";
const commonLabelClasses = "ml-3 text-sm text-gray-600";
...
export default function Product() {
  ...
  console.log("Products:", products); // Option 1
  // const products = useSelector((state) => state.products.products);
  // console.log("Products" + products);

  // const products = useSelector((state) => state.products.products);

  // console.log("Products: " + JSON.stringify(products, null, 2)); // Option 2
  // console.table(products); // Option 3
  ...
  const handlePaginationChange = (event, value) => {
    ...
    console.log("ndksanfnasofnas" + value);
    const query = searchParams.toString();
    navigate({ search: `?${query}` });
  };
